...
print '<h2>Upload CSV</h2>'.PHP_EOL;
print '<br>';
print '<form action="uploadcsv.php" method="POST"  enctype="multipart/form-data">'.PHP_EOL;
...
print '<br><br>';
print '<label for picture>Please select the CSV</label>'.PHP_EOL;
print '<input type="file"  name="csv"/>'.PHP_EOL;
